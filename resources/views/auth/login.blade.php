                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="form space-y-4 md:space-y-6">
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Belum memiliki akun? <a href="{{ url('auth/register') }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.form').on('submit', function(e){
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ config('app.base_api') }}/auth/login",
                    data: {
                        email: $('#email').val(),
                    ...
                    success: function(response) {
                        Swal.fire({
                            ...
                            window.location.href = `{{ url('auth/sr') }}?token=${response.data.access_token}&name=${response.data.user.name}`;
                        });
                    },
